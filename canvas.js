...
ctx.fillStyle="#E72512";
ctx.fillRect(402,220,85,95);
ctx.clearRect(443,247,10,20)
...
//atea 2
ctx.fillStyle="#E72512";
ctx.fillRect(273,220,85,95);
ctx.clearRect(328,247,10,20)
...
//manguera
ctx.fillStyle="black";
ctx.fillRect(362,275,27,20);

ctx.beginPath()
ctx.arc(375,285,4,0,(Math.PI/180)*360,true);
ctx.strokeStyle = "#f00";
ctx.lineWidth = 10;
ctx.stroke();

ctx.fillStyle="#78858B	";
ctx.fillRect(362,295,27,20);

ctx.fillStyle="rgba(200,229,235,.3)";
ctx.fillRect(361,276,28,20);
